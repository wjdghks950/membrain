...
class MembrainAgent(Agent):
    ...
    def add_cmdline_args(argparser):
        ...
        agent = argparser.add_argument_group('Membrain Arguments')
        ...
        agent.add_argument('-opt', '--optimizer', default='sgd',
                           choices=MembrainAgent.OPTIM_OPTS.keys(),
        ...
        MembrainAgent.dictionary_class().add_cmdline_args(argparser)
        return agent
    ...
    def __init__(self, opt, shared=None):
        ...
        if shared:
            ...
            if not hasattr(self, 'model_class'):
                ...
                # this is where the model "Membrain" is called
                self.model_class = Membrain
        ...
        if 'train' in opt.get('datatype', ''):
            ...
            # set up optimizer
            lr = opt['learningrate']
            optim_class = MembrainAgent.OPTIM_OPTS[opt['optimizer']]
            kwargs = {'lr': lr}
            ...
            if opt['embedding_type'].endswith('fixed'):
                print('Membrain: fixing embedding weights.')
...
class PerplexityEvaluatorAgent(MembrainAgent):
